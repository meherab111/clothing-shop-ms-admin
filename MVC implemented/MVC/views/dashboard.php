...
<div class="dashboard-time">
     <h4 >Current Date and Time: <span id="datetime"></span></h4>
			...
			<div class="dashboard-div">
				...
				<div class="contents">
					<ul class="content-ul">
						...
						<li> <a href="../views/product.php" class="dashboard-ancor-1">
								<strong>• Product Details</strong>
							</a>
						</li>

						<li> <a href="../views/employee.php" class="dashboard-ancor-2">
								<strong>• Employee Salary</strong>
							</a></li>

						<li> <a href="../views/send_report.php" class="dashboard-ancor-3">
								<strong>• Send Report</strong>
							</a>
						</li>

						<li> <a href="../views/emp_request.php" class="dashboard-ancor-4">
			...
			<a href="../controller/logout.php" class="dashboard-button"> <img class="img-logout" src="logout.png" alt="Logout Button">
			</a>
			<br><br><br>
